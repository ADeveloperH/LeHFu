 ...
 */
package com.jiefutong.lehfu.widget.wheelview.widget;
...
import com.jiefutong.lehfu.widget.wheelview.adapter.BaseWheelAdapter;
import com.jiefutong.lehfu.widget.wheelview.adapter.SimpleWheelAdapter;
import com.jiefutong.lehfu.widget.wheelview.common.WheelConstants;
import com.jiefutong.lehfu.widget.wheelview.common.WheelViewException;
import com.jiefutong.lehfu.widget.wheelview.graphics.DrawableFactory;
import com.jiefutong.lehfu.widget.wheelview.util.WheelUtils;
...
public class WheelView<T> extends ListView implements IWheelView<T> {
    ...
    private SparseArray<List<T>> mJoinMap;    // 副滚轮数据列表
        ...
        public void handleMessage(Message msg) {
            if (msg.what == WheelConstants.WHEEL_SCROLL_HANDLER_WHAT) {
                ...
                if (mJoinWheelView != null) {
                    if (mJoinMap.size() != 0) {
                        mJoinWheelView.resetDataFromTop(mJoinMap.get(getCurrentPosition()));
                    } else {
     ...
     * @param map
     */
    public void joinDatas(SparseArray<List<T>> map) {
        mJoinMap = map;
    }

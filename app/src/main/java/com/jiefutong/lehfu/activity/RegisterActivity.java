...
//                .error(R.drawable.captcha_default)
    ...
    @OnClick({R.id.iv_code, R.id.tv_get_sms_code, R.id.btn_register, R.id.tv_login})
    ...
    private void register() {
        ...
        Http.post(Http.REGISTER, requestParams,
                new MyTextAsyncResponseHandler(act, "注册中...") {
    ...
    private void getSmsCode() {
        ...
        requestParams.put("uuid", uuid);
        requestParams.put("verify", inputCode);
        Http.post(Http.GET_SMS_CODE, requestParams,

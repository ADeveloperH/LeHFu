 ...
 */
package com.jiefutong.lehfu.widget.wheelview.common;
...
public class WheelConstants {
     ...
     * holo皮肤默认背景
     */
    public static final int WHEEL_SKIN_HOLO_BG = Color.parseColor("#F7F7F7");

    /**
     * holo皮肤默认选中框颜色
     */
    public static final int WHEEL_SKIN_HOLO_BORDER_COLOR = Color.parseColor("#F0F0F0");

    /**
     * 滚轮item高度
     */
    public static final int WHEEL_ITEM_HEIGHT = 47;
